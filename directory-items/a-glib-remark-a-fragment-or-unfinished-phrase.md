...
A proposed re-sequencing of the Latin alphabet, using a single steel meter. A process whereby forms are broken down to their most primary elements. First, the bar is fired using a blowtorch, then  shaped, leaving dextrous, hand-written traces from one form to the next. During the struggle, unnamed glyphs emerge between forms; letters between letters; letters within letters. <br><br>
